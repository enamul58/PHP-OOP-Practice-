	...
	<head>
		<style>
			...
			.headeroption h2, .footeroption h2{ margin:0;}
			 ...
			 .main_left{float: left; width: 350px; margin-right: 16px; border-right: 5px solid green;}
			 #myform{ width: 400px; padding: 10px; border: 1px solid #fff}
			 .tblone{width: 400px; border:1px solid #fff; margin: 0;  }
	...
	<body>
		<div class="php_coding">
			...
			<section class="subject">
				<p style="color: green; text-align:center;">CRUD WITH PDO</p><span style="float:right"><a href="index.php">Creat New</a></span>
			</section>
